...
/**
  ...
  public boolean addAll(PointsToSetInternal other, final PointsToSetInternal exclude) {
    ...
    if (!G.v().PointsToSetInternal_warnedAlready) {
      ...
      logger.debug(new StringBuilder().append("").append("this is of type ").append(getClass().getName()).toString());
      logger.debug(new StringBuilder().append("").append("other is of type ").append(other.getClass().getName()).toString());
      if (exclude == null) {
        logger.debug("" + "exclude is null");
      } else {
        logger.debug(new StringBuilder().append("").append("exclude is of type ").append(exclude.getClass().getName()).toString());
      }
...
public String toString() {
    ...
    this.forall(new P2SetVisitor() {
      @Override
	public final void visit(Node n) {
        ret.append(new StringBuilder().append("").append(n).append(",").toString());
      }
    });
    return ret.toString();
  }
