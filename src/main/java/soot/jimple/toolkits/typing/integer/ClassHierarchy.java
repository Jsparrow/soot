...
public class ClassHierarchy {
  ...
  public final TypeNode BOOLEAN = new TypeNode(0, BooleanType.v());
	...
	// becomes short
	  ...
	  private final boolean[][] ancestors1 = { { false, false, false, false, false, true, false, false, false, },
	...
	private final boolean[][] ancestors2 = { { false, true, true, true, true, false, false, true, true, },
	...
	private final boolean[][] descendants1 = { { false, false, false, false, false, false, true, false, false, },
	      ...
	      { false, false, false, false, false, false, true, true, false, }, };
	private final boolean[][] descendants2 = { { false, false, false, false, false, false, false, false, false, },
	      ...
	      { true, false, false, false, false, false, false, true, false, }, };
	private final TypeNode[][] lca1 = { { BOOLEAN, TOP, TOP, TOP, TOP, TOP, BOOLEAN, TOP, TOP, },
	...
	private final TypeNode[][] lca2 = { { BOOLEAN, BYTE, SHORT, CHAR, INT, null, null, R0_127, R0_32767, },
	...
	private final TypeNode[][] gcd1 = { { BOOLEAN, R0_1, R0_1, R0_1, R0_1, BOOLEAN, R0_1, R0_1, R0_1, },
	...
	private final TypeNode[][] gcd2 = { { BOOLEAN, BOOLEAN, BOOLEAN, BOOLEAN, BOOLEAN, null, null, BOOLEAN, BOOLEAN, },
	...
	public TypeNode lca_2(int t1, int t2) {
	    return lca2[convert(t1)][convert(t2)];
	  }
	...
	public TypeNode gcd_2(int t1, int t2) {
	    return gcd2[convert(t1)][convert(t2)];
	  }
