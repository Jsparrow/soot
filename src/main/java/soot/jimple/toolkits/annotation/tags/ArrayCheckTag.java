...
public String toString() {
    return new StringBuilder().append(lowerCheck ? "[potentially unsafe lower bound]" : "[safe lower bound]").append("").append(upperCheck ? "[potentially unsafe upper bound]" : "[safe upper bound]").toString();
  }
}
