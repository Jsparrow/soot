...
public class ReflectiveCallsInliner extends SceneTransformer {
  private static final String ALREADY_CHECKED_FIELDNAME = "SOOT$Reflection$alreadyChecked";
	...
	private SootMethodRef uninterpretedMethod;
	...
	@Override
	  protected void internalTransform(String phaseName, @SuppressWarnings("rawtypes") Map options) {
	    if (!initialized) {
	      ...
	      uninterpretedMethod = Scene.v().makeMethodRef(Scene.v().getSootClass("soot.rtlib.tamiflex.OpaquePredicate"),
	    ...
	    rti.methodsContainingReflectiveCalls().forEach(m -> {
	...
	private void inlineRelectiveCalls(SootMethod m, Set<String> targets, Kind callKind) {
	    ...
	    while (iter.hasNext()) {
	      ...
	      if (s.containsInvokeExpr()) {
	        ...
	        } else if (callKind == Kind.ConstructorNewInstance && "<java.lang.reflect.Constructor: java.lang.Object newInstance(java.lang.Object[])>"
	            .equals(ie.getMethodRef().getSignature())) {
	          found = true;
	        ...
	        } else if (callKind == Kind.MethodInvoke && "<java.lang.reflect.Method: java.lang.Object invoke(java.lang.Object,java.lang.Object[])>"
	            .equals(ie.getMethodRef().getSignature())) {
	          found = true;
	        ...
	        for (String target : targets) {
	          ...
	          StaticInvokeExpr staticInvokeExpr = Jimple.v().newStaticInvokeExpr(uninterpretedMethod);
