  ...
  static String freshSeparator = "_";
	...
	/**
	  ...
	  protected Local fetchNewLocal(Local local, Integer subscript) {
	    ...
	    // take care of it.
	    String name = new StringBuilder().append(oldLocal.getName()).append(freshSeparator).append(subscript).toString();
	...
	/**
	  ...
	  public String makeUniqueLocalName(String dupName, Set<String> localNames) {
	    ...
	    while (localNames.contains(newName)) {
	      newName = new StringBuilder().append(dupName).append(freshSeparator).append(counter++).toString();
	    }
