...
public String toString() {
    return new StringBuilder().append("dup2_x1.").append(Baf.bafDescriptorOf(mOp1Type)).append(".").append(Baf.bafDescriptorOf(mOp2Type)).append("_").append(Baf.bafDescriptorOf(mUnderType))
			.toString();
  }
