	    ...
	    while (asgit.hasNext()) {
	      ...
	      if (s instanceof TableSwitchStmt) {
	        ...
	        for (int i = 0; i < target_count; i++) {
	          build_Bindings(as, Integer.valueOf(i + tss.getLowIndex()), asg.get_AugStmt((Stmt) tss.getTarget(i)));
	        }
	        ...
	        for (int i = 0; i < target_count; i++) {
	          build_Bindings(as, Integer.valueOf(lss.getLookupValue(i)), asg.get_AugStmt((Stmt) lss.getTarget(i)));
	        }
