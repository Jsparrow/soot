 ...
 */
public abstract class ImportDecl extends ASTNode<ASTNode> {
  protected java.util.Map importedTypes_String_values;
	...
	/**
	  ...
	  boolean isFinal = this.is$Final();
	    SimpleSet importedTypes_String_value = importedTypes_compute();
	...
	/**
	   * @apilevel internal
	   */
	  private SimpleSet importedTypes_compute() {  return SimpleSet.emptySet;  }
	/**
	   * @attribute syn
	   * @aspect TypeScopePropagation
	  ...
	  public String typeName() {
	    ...
	    while(a.hasPrevExpr() && a.prevExpr() instanceof Access) {
	      ...
	      if(pred.isTypeAccess()) {
			name = new StringBuilder().append(((TypeAccess)pred).nameWithPackage()).append(".").append(name).toString();
		}
	      a = pred;
	    }
	    return name;
	...
	/**
	  ...
	  int num = state.boundariesCrossed;
	  boolean isFinal = this.is$Final();
	    SimpleSet importedFields_String_value = importedFields_compute();
	      if(isFinal && num == state().boundariesCrossed) {
	...
	/**
	   * @apilevel internal
	   */
	  private SimpleSet importedFields_compute() {  return SimpleSet.emptySet;  }
	/**
	   * @attribute syn
	   * @aspect StaticImports
	  ...
	  int num = state.boundariesCrossed;
	  boolean isFinal = this.is$Final();
	    Collection importedMethods_String_value = importedMethods_compute();
	      if(isFinal && num == state().boundariesCrossed) {
	...
	/**
	   * @apilevel internal
	   */
	  private Collection importedMethods_compute() {  return Collections.EMPTY_LIST;  }
	/**
	   * @attribute inh
	   * @aspect TypeScopePropagation
