 ...
 */
public class GenericClassDeclSubstituted extends GenericClassDecl implements MemberSubstitutor {
  private static final Logger logger = LoggerFactory.getLogger(GenericClassDeclSubstituted.class);
/**
   * @apilevel internal
   * @ast method 
   * 
