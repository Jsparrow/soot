 ...
 */
public abstract class ReferenceType extends TypeDecl {
  protected java.util.Map narrowingConversionTo_TypeDecl_values;
	...
	/**
	  ...
	  private boolean narrowingConversionTo_compute(TypeDecl type) {
	    ...
	    if("java.lang.Object".equals(fullName()) && type.isInterfaceDecl()) {
			return true;
		}
	    // Dragons
	...
	public boolean isValidAnnotationMethodReturnType() {
	    ...
	    if("java.lang.Class".equals(fullName())) {
			return true;
		}
	    // include generic versions of Class
	    if("java.lang.Class".equals(erasure().fullName())) {
			return true;
		}
	    return false;
	  }
	...
	/**
	  ...
	  private TypeDecl unboxed_compute() {
	    if("java.lang".equals(packageName()) && isTopLevelType()) {
	      String n = name();
	      if("Boolean".equals(n)) {
			return typeBoolean();
		}
	...
	public boolean isBoolean() {
	    ASTNode$State state = state();
	    try {  return "java.lang.Boolean".equals(fullName()) && unboxed().isBoolean();  }
	    finally {
	    }
	  }
	/**
	...
	/**
	  ...
	  private String jvmName_compute() {
	    if(!isNestedType()) {
			...
			return new StringBuilder().append(enclosingType().jvmName()).append("$").append(uniqueIndex()).append(name()).toString();
		} else {
			return new StringBuilder().append(enclosingType().jvmName()).append("$").append(name()).toString();
		}
	  }
	/**
	   * @attribute syn
