 ...
 */
public class AnnotationDecl extends InterfaceDecl {
  private static final Logger logger = LoggerFactory.getLogger(AnnotationDecl.class);
/**
   * @apilevel internal
   */
...
public boolean Define_boolean_mayUseAnnotationTarget(ASTNode caller, ASTNode child, String name) {
    if(caller == getModifiersNoTransform()) {
      return "ANNOTATION_TYPE".equals(name) || "TYPE".equals(name);
    }
