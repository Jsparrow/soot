 ...
 */
public class ResourceDeclaration extends VariableDeclaration {
...
public void nameCheck() {
		...
		if (resourcePreviouslyDeclared(name())) {
			error(new StringBuilder().append("A resource with the name ").append(name()).append(" has already been declared in this try statement.").toString());
		}
