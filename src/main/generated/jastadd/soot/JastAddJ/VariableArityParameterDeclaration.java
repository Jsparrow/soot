 ...
 */
public class VariableArityParameterDeclaration extends ParameterDeclaration {
  private static final Logger logger = LoggerFactory.getLogger(VariableArityParameterDeclaration.class);
/**
   * @apilevel internal
   */
