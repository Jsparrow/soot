 ...
 */
public class GenericInterfaceDecl extends InterfaceDecl implements GenericTypeDecl {
  private static final Logger logger = LoggerFactory.getLogger(GenericInterfaceDecl.class);
/**
   * @apilevel internal
   */
...
public void typeCheck() {
    ...
    if(instanceOf(typeThrowable())) {
		error(new StringBuilder().append(" generic interface ").append(typeName()).append(" may not directly or indirectly inherit java.lang.Throwable").toString());
	}
  }
/**
   * @ast method 
