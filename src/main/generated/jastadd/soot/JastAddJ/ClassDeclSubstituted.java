 ...
 */
public class ClassDeclSubstituted extends ClassDecl implements MemberSubstitutor {
  private static final Logger logger = LoggerFactory.getLogger(ClassDeclSubstituted.class);
/**
   * @apilevel internal
   * @ast method 
   * 
