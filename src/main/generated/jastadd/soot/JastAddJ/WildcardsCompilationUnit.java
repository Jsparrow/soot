 ...
 */
public class WildcardsCompilationUnit extends CompilationUnit {
  private static final Logger logger = LoggerFactory.getLogger(WildcardsCompilationUnit.class);
/**
   * @apilevel internal
   */
