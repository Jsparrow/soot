 ...
 */
public class ForStmt extends BranchTargetStmt implements VariableScope {
  private static final Logger logger = LoggerFactory.getLogger(ForStmt.class);
...
public void typeCheck() {
	...
	if(!cond.isBoolean()) {
        error(new StringBuilder().append("the type of \"").append(getCondition()).append("\" is ").append(cond.name()).append(" which is not boolean").toString());
      }
  }
/**
   * @ast method 
