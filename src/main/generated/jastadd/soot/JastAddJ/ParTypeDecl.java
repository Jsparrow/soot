...
@Override TypeDecl substitute(TypeVariable typeVariable);
...
void transformation();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"}) boolean isParameterizedType();
  /**
   * @attribute syn
   * @aspect Generics
