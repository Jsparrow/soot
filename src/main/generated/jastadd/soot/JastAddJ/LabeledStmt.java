 ...
 */
public class LabeledStmt extends BranchTargetStmt {
  private static final Logger logger = LoggerFactory.getLogger(LabeledStmt.class);
/**
   * @apilevel internal
   * @ast method 
   * 
...
public void nameCheck() {
    ...
    boolean condition = stmt != null && stmt.enclosingBodyDecl() == enclosingBodyDecl();
	if(condition) {
...
/**
  ...
  public LabeledStmt lookupLabel(String name) {
    ...
    if(lookupLabel_String_values == null) {
		lookupLabel_String_values = new java.util.HashMap(4);
	}
