 ...
 */
public abstract class CatchClause extends ASTNode<ASTNode> implements VariableScope {
  protected java.util.Map parameterDeclaration_String_values;
	...
	/**
	  ...
	  boolean isFinal = this.is$Final();
	    SimpleSet parameterDeclaration_String_value = parameterDeclaration_compute();
	...
	/**
	   * @apilevel internal
	   */
	  private SimpleSet parameterDeclaration_compute() {  return SimpleSet.emptySet;  }
	/**
	   * @attribute syn
