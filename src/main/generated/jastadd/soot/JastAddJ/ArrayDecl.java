 ...
 */
public class ArrayDecl extends ClassDecl {
  private static final Logger logger = LoggerFactory.getLogger(ArrayDecl.class);
...
/**
  ...
  private String jvmName_compute() {
    ...
    if(elementType().isReferenceType()) {
		return new StringBuilder().append(dim.toString()).append("L").append(elementType().jvmName()).append(";").toString();
	} else {
