 ...
 */
public class EnumDecl extends ClassDecl {
  private static final Logger logger = LoggerFactory.getLogger(EnumDecl.class);
/**
   * @ast method 
   * @aspect Enums
...
public void checkModifiers() {
	...
	s.append(new StringBuilder().append("").append(name()).append(" lacks implementations in one or more ").append("enum constants for the following methods:\n").toString());
