 ...
 */
public abstract class BitwiseExpr extends Binary {
  /**
	   * @apilevel internal
	   */
	...
	public void typeCheck() {
	    ...
	    if(left.isIntegralType() && right.isIntegralType()) {
			...
			error(new StringBuilder().append(left.typeName()).append(" is not compatible with ").append(right.typeName()).toString());
		}
	  }
	/**
