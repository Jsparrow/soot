 ...
 */
public class FieldDeclarationSubstituted extends FieldDeclaration {
  private static final Logger logger = LoggerFactory.getLogger(FieldDeclarationSubstituted.class);
/**
   * @apilevel internal
   * @ast method 
   * 
