  ...
  /**
	...
	/**
	  ...
	  private Constant constant_compute() {
	    throw new UnsupportedOperationException(new StringBuilder().append("ConstantExpression operation constant").append(" not supported for type ").append(getClass().getName()).toString()); 
	  }
	/**
	   * @attribute syn
	   * @aspect ConstantExpression
	...
	public String dumpString() {
	    ASTNode$State state = state();
	    try {  return new StringBuilder().append(getClass().getName()).append(" [").append(getLITERAL()).append("]").toString();  }
	    finally {
	    }
	  }
	/**
