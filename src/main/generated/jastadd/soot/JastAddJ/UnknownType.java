 ...
 */
public class UnknownType extends ClassDecl {
  ...
  public boolean subtype(TypeDecl type) {
    ...
    if (!state.IN_CIRCLE) {
      ...
      do {
        ...
        state.CHANGE = false;
        new_subtype_TypeDecl_value = subtype_compute();
	...
	_value.visited = Integer.valueOf(state.CIRCLE_INDEX);
	boolean new_subtype_TypeDecl_value = subtype_compute();
...
/**
   * @apilevel internal
   */
  private boolean subtype_compute() {  return true;  }
/**
   * @attribute syn
   * @aspect GenericsSubtype
