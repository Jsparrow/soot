 ...
 */
public abstract class EqualityExpr extends RelationalExpr {
  /**
	   * @ast method 
	   * 
	   */
	...
	public void typeCheck() {
	    ...
	    error(new StringBuilder().append(left.typeName()).append(" can not be compared to ").append(right.typeName()).toString());
	  }
	/**
