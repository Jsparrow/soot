 ...
 */
public class InstanceInitializer extends BodyDecl {
...
void checkUnreachableStmt() {
    if(!getBlock().canCompleteNormally()) {
		error(new StringBuilder().append("instance initializer in ").append(hostType().fullName()).append(" can not complete normally").toString());
	}
  }
/**
