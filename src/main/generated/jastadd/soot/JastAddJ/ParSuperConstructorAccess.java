 ...
 */
public class ParSuperConstructorAccess extends SuperConstructorAccess {
  private static final Logger logger = LoggerFactory.getLogger(ParSuperConstructorAccess.class);
/**
   * @ast method 
   * 
   */
